...
params:
  ...
  path:
    label: "File path"
    value: "X:/some/path/for/default/proteinGroups.txt"
  pathRDS:
    label: "File path RDS file"
    value: "X:/some/path/for/default/data/results_v002/"
  unique: 
...
The results are saved as csv and RDS files for further processing.
